#
# Sphinx configuration for aiida-quantum-transport
#
...
import aiida_quantum_transport
...
release = aiida_quantum_transport.__version__
...
html_title = f"aiida-quantum-transport v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-quantum-transport.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_quantum_transport")
